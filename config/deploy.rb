...
# Default value for :linked_files is []
 set :linked_files, %w{config/mongoid.yml config/initializers/front_app_url.rb config/initializers/facebook.rb config/initializers/behave_io.rb config/initializers/secret_token.rb config/initializers/aws_credentials.rb FrontApp/src/app/config/config.js}
