    ...
    class Entities < Grape::API
      ...
      namespace :entities do 
        get do 
          ...
          present :item, [:current_user_commented, :current_user_score, :tags, :id, :name, :lovers_count, :likers_count, :mehers_count, :haters_count, :comments_count, :comments, :latest_evaluation_at].sort
